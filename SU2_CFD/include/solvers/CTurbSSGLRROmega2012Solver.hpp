/*!
 * \file CTurbSSGLRROmega2012Solver.hpp
 * \brief Headers of the CTurbSSGLRROmega2012Solver class
...
/*!
 * \class CTurbSSGLRROmega2012Solver
 * \brief Main class for defining the turbulence model solver.
 * \ingroup Turbulence_Model
 * \author A. Campos, F. Palacios, T. Economon
 */
class CTurbSSGLRROmega2012Solver final : public CTurbSolver {
private:
  const CVariable* flowState = nullptr;
  /*!
...
public:
   ...
   */
  CTurbSSGLRROmega2012Solver(CGeometry *geometry, CConfig *config, unsigned short iMesh);

  /*!
   * \brief Destructor of the class.
   */
  ~CTurbSSGLRROmega2012Solver() = default;
   ...
   */
  inline su2double GetTke_Inf(void) const override {
    return 0.5*(Solution_Inf[0]+Solution_Inf[1]+Solution_Inf[2]);
  }
   ...
   */
  inline su2double GetOmega_Inf(void) const override { return Solution_Inf[6]; }
