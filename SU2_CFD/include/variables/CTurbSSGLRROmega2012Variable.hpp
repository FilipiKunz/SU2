/*!
 * \file CTurbSSGLRROmega2012Variable.hpp
...
/*!
 * \class CTurbSSGLRROmega2012Variable
 * \brief Main class for defining the variables of the turbulence model.
 * \ingroup Turbulence_Model
 * \author A. Bueno.
 */

class CTurbSSGLRROmega2012Variable final : public CTurbVariable {
protected:
  VectorType F1;
  VectorType F2;
...
public:
   ...
   */
  CTurbSSGLRROmega2012Variable(su2double kine, su2double omega, su2double mut, unsigned long npoint,
                   unsigned long ndim, unsigned long nvar, CConfig *config);

  /*!
   * \brief Destructor of the class.
   */
  ~CTurbSSGLRROmega2012Variable() override = default;
